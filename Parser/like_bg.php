...
if(isset($_POST))
{
   ...
   if(!preg_match("/\.(gif|jpg|png|jpeg)$/i", $fileName)){
	...
	$sql = "SELECT back FROM likes WHERE name_id='$name_id' LIMIT 1";
	...
	$sql = "UPDATE likes SET back='$db_file_name' WHERE name_id='$name_id' LIMIT 1";
	$query = mysqli_query($con,$sql);
	
	//echo "he".$src;
	//echo '<img src="blue.jpg">';
	$dp = '<img src="'.$src.'" id="preview_bg" style="width:900;height:300px;">';
	/*$insrt_post = '<img src="'.$src_insrt.'" id="preview_cp" style="width:500;height:300px;" onclick="showPhoto()">';
