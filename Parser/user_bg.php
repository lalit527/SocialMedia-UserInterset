...
if(isset($_POST))
{
   ...
   $db_file_name = get_rand_id(12).".".$fileExt;
   /*if($fileSize > 4048576){
   ...
   if(!preg_match("/\.(gif|jpg|png|jpeg)$/i", $fileName)){
	...
	if($profile_pic != "" || $profile_pic != NULL){
	 ...
	 copy("../Users/".$log_username."/".$db_file_name,          "../Users/".$log_username."/album/theme/".$db_file_name);
	...
	$target_file = "../likes/$log_username/$db_file_name";
	$resized_file = "../likes/$log_username/$db_file_name";
	$wmax = 1500;
	$hmax = 1000;
