...
namespace StarTrinity.FaceRecognition.SL.Sample.Web
{
	public partial class Login : System.Web.UI.Page
	{
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			initParams.Attributes.Add("value", String.Format("token={0},mode=login,redirect=Home.aspx", token));
			// ,serviceurl=http://startrinity.com/Services/FaceRecognitionService.asmx
		}
	}
}