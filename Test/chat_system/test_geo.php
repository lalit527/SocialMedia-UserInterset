...
<script type="text/javascript" src="chaaaaaaaaaat.js" ></script>
...
function fun(f,u){
	...
	var ajax = ajaxObj("POST","../../Parser/chat_parser.php");
...
function requestNewMessages(f,u)
{
...
setTimeout("requestNewMessages(f,u);", updateInterval);
}
}
catch(e)
{
