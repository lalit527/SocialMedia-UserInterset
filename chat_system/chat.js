...
"&fname=" + encodeURIComponent(currentFriend) +
...
friendArray = response.getElementsByTagName("fname");
picArray = response.getElementsByTagName("pic");
...
htmlMessage += '<div style="border:thin sold #000;border-radius:2px;background:#ccc;width:inherit">'+message.toString()+'</div>';
htmlMessage += "</div>";
// display the message
