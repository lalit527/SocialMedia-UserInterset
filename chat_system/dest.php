...
$orLogic = "";
	...
	while($row = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
		...
		$friendsHTML .= '<div id="chat_wrap" onclick="fun(\''.$friend_username.'\',\''.$log_username.'\')"><img class="friendpics" src="'.$friend_pic.'" alt="'.$friend_username.'" title="'.$friend_username.'" style="border:#000 1px solid; width:30px; height:30px; margin:2px;"  >'.$friend_username.'</div>';
	}
